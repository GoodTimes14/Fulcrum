...
import it.raniero.fulcrum.bungeecord.utils.BungeeUtils;
...
public abstract class FulcrumCommandBungee extends FulcrumCommand {
    ...
    public void sendCommandUsage(FulcrumSource source, String label, CommandScheme scheme) {
        ...
        if (sender instanceof ProxiedPlayer player) {
            ...
            player.sendMessage(BungeeUtils.translateComponent(commandComponent));
    ...
    private void addArgumentComponents(TextComponent component, CommandScheme scheme, CommandScheme parent) {
        ...
        for (Argument argument : scheme.arguments().values()) {
            ...
            argumentComponent.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(builder.create())));
            component.addExtra(" ");
