...
public class FulcrumMessagesHolder implements SettingsHolder {
    ...
    @Comment(
            value = "This is the error displayed when an unexpected source tries to execute a command (console or player only command)")
    ...
    @Comment(
            value = "This is the error message displayed when a source does not have the required permission to do a certain command")
    public static final Property<String> NO_PERMISSION_SOURCE =
            new StringProperty(createPath("no","permission", "command", "source"),
